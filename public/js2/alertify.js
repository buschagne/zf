	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				submit : "<button type=\"submit\" class=\"alertify-button alertify-button-ok btn btn-info round-mini\" id=\"alertify-ok\">{{ok}}</button>",
				ok     : "<a href=\"#\" class=\"alertify-button alertify-button-ok btn btn-info round-mini\" id=\"alertify-ok\">{{ok}}</a>",
				cancel : "<a href=\"#\" class=\"alertify-button alertify-button-cancel btn btn-danger round-mini\" id=\"alertify-cancel\">{{cancel}}</a>"
			},
