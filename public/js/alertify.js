	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				submit : "<button type=\"submit\" class=\"alertify-button alertify-button-ok btn plt-turquoise\" id=\"alertify-ok\">{{ok}}</button>",
				ok     : "<a href=\"#\" class=\"alertify-button alertify-button-ok btn plt-peter-river\" id=\"alertify-ok\">{{ok}}</a>",
				cancel : "<a href=\"#\" class=\"alertify-button alertify-button-cancel btn plt-alizarin\" id=\"alertify-cancel\">{{cancel}}</a>"
			},
